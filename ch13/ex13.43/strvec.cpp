 ...
 *  @author     Alan.W
 *  @date       06  JAN 2014
 *  @remark     Using for_each and a lambda in place of for loop in  the member
 *              of free().
 ***************************************************************************/
...
//! you prefer, and why?
//  The new version is better. Compared to the old one, it doesn't need to
//  worry about the order and decrement.So more straightforward and handy.
//  The only thing to do for using this approach is to add "&" to build the pointers
//  to string pointers.
//!
