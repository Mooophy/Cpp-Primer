...
- c) If there are no meaningful default values for a class, the class should not provide a default constructor. (**true**, the class which is meaningless is no need to provide default constructor.)
